...
public enum NetworkErrorCode implements ErrorCode {
    ...
    NOT_NULL_INTERFACE_SECURITY_GROUP_IDS(400, "ACC-NETWORK-NOT-NULL-INTERFACE-SECURITY-GROUP-IDS", "인터페이스의 보안 그룹 ID는 null이 될 수 없습니다."),
    ...
    OVERLAPPING_SUBNET_CIDR(400, "ACC-NETWORK-OVERLAPPING-SUBNET-CIDR", "서브넷 CIDR 값이 서로 겹칩니다."),
    INVALID_SUBNET_GATEWAY_IP(400, "ACC-NETWORK-INVALID-SUBNET-GATEWAY-IP", "서브넷 게이트웨이 IP가 유효하지 않습니다."),
