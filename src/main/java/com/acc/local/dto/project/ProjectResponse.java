...
public record ProjectResponse(
	...
	// 생성된 프로젝트
	public static ProjectResponse from(ProjectServiceDto projectServiceDto, UserKeystone owner, List<ProjectParticipantDto> participants) {
	...
	// 프로젝트 요청
	public static ProjectResponse from(ProjectRequestDto projectRequestDto, UserKeystone projectRequestUser) {
		return ProjectResponse.builder()
